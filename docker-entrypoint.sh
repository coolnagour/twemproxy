...
echo ""
echo "Checking if stats are enabled..."
/usr/local/sbin/nutcracker --help | grep -i stats || echo "Stats option not found in help"
echo ""
echo "Checking build configuration..."
/usr/local/sbin/nutcracker --describe-stats 2>&1 | head -5 || echo "Stats not compiled in"
echo ""
echo " >>> Starting nutcracker..."
